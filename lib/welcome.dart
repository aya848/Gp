...
/*class CustomTextField extends StatelessWidget {
  ...
  final Icon icon_1;
  final IconButton icon_2;
  final bool obsecure ;
  final bool showpassword;

  const CustomTextField({Key key, /*this.controller,*/ this.text,this.inputType,this.icon_1,this.icon_2,this.obsecure,this.showpassword}): super(key : key);
  @override
  Widget build(BuildContext context) {
