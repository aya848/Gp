            ...
            Directionality(
              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.teal[300],fontFamily: 'Tajawal'),
    ...
    return Container(
      ...
      child: Material(
        ...
        child: MaterialButton(
          ...
          child: Text(text, textAlign:TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,fontFamily: 'Tajawal'),
        ),
      ),
    )
    );
